...
class Expression:
    ...
    def Discriminant(self):
        ...
        ax0.text(0.4, y, f'Rovnica: ', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.20
        ...
        ax1.text(0.4, y, 'Výpočet diskriminntu:', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.15
    ...
    # Remove axes
        ...
        ax2.text(0.4, y, 'Výpočet x1: ', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.15
    ...
    # Remove axes
        ...
        ax3.text(0.4, y, 'Výpočet x2: ', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.15
    ...
    # Remove axes
        ...
        sol1 = (-self.b -(sp.sqrt(D_list[0])))/(2*self.a)
        sol2 = (-self.b +(sp.sqrt(D_list[0])))/(2*self.a)
        tftx1 = sp.symbols(f'({sol1})')
        ...
        ax4.text(0.4, y, f'Skúška právnosti s {x1}: ', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.20

        latex_equation = sp.latex(self.equation)
        ax4.text(0.4, y, f'${latex_equation}$', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.15

        tftequation = sp.Eq(self.a*(tftx1)**2 + self.b*(tftx1) + self.c, 0)
        latex_equation = sp.latex(tftequation)
        ax4.text(0.4, y, f'${latex_equation}$', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.15


        tftax12 = sp.symbols(f'{self.a*sol1**2}')

        tftequation = sp.Eq(tftax12 + self.b*sol1 + self.c, 0)
        latex_equation = sp.latex(tftequation)
        ax4.text(0.4, y, f'${latex_equation}$', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.15
    ...
    # Remove axes
        ...
        ax5.text(0.4, y, f'Skúška správnosti s {x2}: ', ha="center", va="center", fontsize=20, color="black")
        y = y - 0.20
    ...
    def Factoring(self):
        ...
        if len(SOLUTION)>1:
            ...
            ax1.text(0.4, y, f'Vzorce: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.20
            ...
            ax2.text(0.4, y, f'Výsledky: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.17
            ...
            ax3.text(0.4, y, f'Skúška správnosti s {x1}: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.20

            latex_equation = sp.latex(self.equation)
            ax3.text(0.4, y, f'${latex_equation}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15
        ...
        # Remove axes
            ...
            ax4.text(0.4, y, f'Skúška správnosti s {x2}: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.20
        ...
        # Remove axes
            ...
            ax3.text(0.4, y, 'Skúška správnosti: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.20
    ...
    def Square(self):
        try:
            ...
            ax1.text(0.4, y, f'${str(a2_eq)}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15

            _2ab_eq = sp.Eq(2*_a_*_b_, (self.b/self.a)*x)
            _2ab_eq = sp.latex(_2ab_eq)
            ax1.text(0.4, y, f'${str(_2ab_eq)}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15

            sb = sp.symbols(f'{self.b/self.a}')
            two = sp.symbols(f'{2}')
            xx = sp.symbols(f'{sb*x}')

            b2_eq = sp.Eq(_b_**2,(xx/(two*x))**two)
            b2_eq = sp.latex(b2_eq)
            ...
            ax2.text(0.4, y, f'Výpočet: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.17



            equation1 = sp.Eq((self.a*x**2 + self.b*x)/self.a, -(self.c/self.a))
            equation1 = sp.latex(equation1)
            ax2.text(0.4, y, f'${str(equation1)}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15

            devided = sp.Eq(x**2 + b*x + _b_**2, _b_**2 + c*-1)
            devided = sp.latex(devided)
            ax2.text(0.4, y, f'${devided}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15
            ...
            ax2.text(0.4, y, f'${square}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15

            sqrt = sp.symbols(f'{b2**2 - c}')
            square = sp.Eq(x+b_2, sp.sqrt(sqrt))
            square = sp.latex(square)
            ax2.text(0.4, y, f'${square}$', ha="center", va="center", fontsize=20, color="black")
            ...
            ax3.text(0.4, y, f'Korene:', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.2

            first_line = sp.Eq((x1 + b2), (round(float((sp.sqrt(b2**2 - c))),2))*-1)
            first_line = sp.latex(first_line)
            ax3.text(0.4, y, f'${first_line}$', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.15
            ...
            if b != 0:
                ...
                ax3.text(0.4, y, f'${calc_x1}$', ha="center", va="center", fontsize=20, color="black")
                y = y - 0.20
            ...
            if b != 0:
                ...
                ax3.text(0.4, y, f'${calc_x2}$', ha="center", va="center", fontsize=20, color="black")
                y = y - 0.20
            ...
            sol1 = round(float(-(sp.sqrt(b2**2 - c)) - b2),1)
            sol2 = round(float((sp.sqrt(b2**2 - c)) - b2), 1)
            tftx1 = sp.symbols(f'({sol1})')
            tftx2 = sp.symbols(f'({sol2})')
            ...
            ax4.text(0.4, y, f'Skúška správnosti s {x1}: ', ha="center", va="center", fontsize=20, color="black")
            y = y - 0.20
...
def genr_expression(expression, amount, type=False):
    ...
    for i in range(amount):
        if expression == "Rovnica":
            problems.append(Equation(type))

        elif expression == "Nerovnica":
...
if __name__ == "__main__":
    genr_expression("Rovnica", 3, "úplná")